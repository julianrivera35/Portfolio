...
const LanguageButton = () => {
    ...
    return (
        <button className="group relative border border-gray-300 bg-white text-slate-500 text-2xl px-2 py-1 rounded xl:min-w-[150px] font-semibold">
            <span className="hidden sm:inline">
                {t("language.buttonLabel")}
            </span>
            <span className="sm:hidden">
                {t("language.buttonLabelShort")}
            </span>
