...
const ProjectCard = ({
    ...
    return (
        <div className='flex flex-col justify-start min-w-[200px] max-w-[550px] md:min-w-[400px] min-h-[450px] bg-slate-200 pt-1 pb-1 pl-3 pr-2 md:mt-0 mt-6 border-2 border-slate-400 rounded-2xl md:mb-0 mb-6'>
